...
Initially, he buys 5 bars and has 5 wrappers after eating them. He turns in 4 of them, leaving him with ,
1 for 2 more bars. After eating those two, he has 3 wrappers, turns in 2 leaving him with 1 wrapper and his new bar.
...
1. He spends 10 on 5 chocolates at 2 apiece. He then eats them and exchanges all 5 wrappers to get 1 more.
   He eats 6 chocolates.

2. He spends his 12 on 3 chocolates at 4 apiece. He has 3 wrappers, but needs 4 to trade for his next chocolate.
...
3. He spends 6 on 3 chocolates at 2 apiece. He then exchanges 2 of the 3 wrappers for 1 additional piece.
   Next, he uses his third leftover chocolate wrapper from his initial purchase
   with the wrapper from his trade-in to do a second trade-in for 1 more piece.
...
def chocolateFeast_v2(n, c, m):
    """
    Second solution on chocolate_feast
    """
    new_bars = wrapper = n // c
    while wrapper >= m:
        new_bars += wrapper // m
...
def chocolateFeast_v3(n, c, m):
    """
    Third solution on chocolate_feast
    """
    new_bars = wrapper = n // c
    while wrapper >= m:
        new_bars += 1
